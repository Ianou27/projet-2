...
describe('AdminManager', () => {
    ...
    it('should getAdminInformations', async () => {
        ...
        await adminManager.getAdminInformations(sio, databaseService, socketID);
    ...
    it('should addVirtualPlayerNames', async () => {
        ...
        await adminManager.addVirtualPlayerNames(sio, databaseService, socketID, 'test', 'test');
    ...
    it('should deleteVirtualPlayerName', async () => {
        ...
        await adminManager.deleteVirtualPlayerName(sio, databaseService, socketID, 'test');
    ...
    it('should modifyVirtualPlayerNames', async () => {
        ...
        await adminManager.modifyVirtualPlayerNames(sio, databaseService, socketID, 'test', 'test');
    ...
    it('should resetAll', async () => {
        ...
        await adminManager.resetAll(sio, databaseService, socketID, dictionaryManager);
    ...
    it('should resetGameHistory', async () => {
        ...
        await adminManager.resetGameHistory(sio, databaseService, socketID);
    ...
    it('should resetVirtualPlayers', async () => {
        ...
        await adminManager.resetVirtualPlayers(sio, databaseService, socketID);
